...
<table class="main">
    <tr>
        <th class="logo">
            <a href="main.jhtml">
                <img src="../resources/admin/images/login.png" alt="国美++" height="50px" width="140px" />
            </a>
        </th>
        <th>
            <div id="nav" class="nav">
                <ul>
                    ...
                    <li>
                        <a href="../qiantai/GM.html" target="_blank">首页</a>
                    </li>
                </ul>
            </div>
            <div class="link">
    ...
    <tr>
        <td id="menu" class="menu">
            <dl id="product" class="default">
                ...
                <dd>
                    <a href="../sptypecontroller/getSpfl.jhtml" target="iframe">商品分类</a>
                </dd>
                <dd>
                    <a href="../con/query.jhtml" target="iframe">商品参数</a>
                </dd>
                <dd>
                    <a href="../hgc/commodityproperty.jsp" target="iframe">商品属性</a>
                </dd>
                <dd>
                    <a href="../specification/list.jhtml" target="iframe">规格管理</a>
                </dd>
                <dd>
                    <a href="../pinpai/pinpai.jsp" target="iframe">品牌管理</a>
                </dd>
                <dd>
            ...
            <dl id="order">
                <dt>订单管理</dt>
                <dd>
                    <a href="../hgc/order/order.jsp" target="iframe">订单管理</a>
                </dd>
                <dd>
            ...
            <dl id="member">
                <dt>会员管理</dt>
                <dd>
                    <a href="../con/queryMember.jhtml" target="iframe">会员管理</a>
                </dd>
                <dd>
            ...
            <dl id="content">
                <dt>内容管理</dt>
                <dd>
                    <a href="../navigation/list.jsp" target="iframe">导航管理</a>
                </dd>
                <dd>
            ...
            <dl id="statistics">
                <dt>统计报表</dt>
                <dd>
                    <a href="../echarts/showEcharts.jsp" target="iframe">访问统计</a>
                </dd>
                <dd>
            ...
            <dl id="system">
                ...
                <dd>
                    <a href="../area/getAreaManage.jhtml" target="iframe">地区管理</a>
                </dd>
                <dd>
...
<script>
    //退出系统方法
    function logout() {
       location.href ="../userController/logout.jhtml";
