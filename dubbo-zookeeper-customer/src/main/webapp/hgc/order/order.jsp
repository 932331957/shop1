...
<table id="ordertable"></table>
    <script>
        ...
        function queryorder(){
            ...
            $('#ordertable').datagrid({
              ...
              */
                ...
                columns:[[
                    {title:'订单编号',field:'id',width:150},

                    {field:'amountpaid',title:'订单金额',width:150},
                    {field:'member',title:'会员',width:180},
                    {field:'consignee',title:'收货人',width:150},
                    {field:'paymentmethodname',title:'支付方式名称',width:150},
                    {field:'shippingmethodname',title:'配送方式名称',width:150},
                    {field:'orderstatus',title:'订单状态',width:150},
                    {field:'paymentstatus',title:'支付状态',width:150},
                    {field:'shippingstatus',title:'配送状态',width:150},
                    {field:'createdate',title:'创建日期',width:150},
                    {field:'act',title:'操作',width:150,
                        formatter: function(value,row,index){

                                return "<a href='javascript:queryorderbyid(\""+row.id+"\")'  >[查看]</a><a href=''>[编辑]</a>";
        ...
        function queryorderbyid(id){
           ...
           /* $.ajax({
                type:"post",
                url:"<%=request.getContextPath()%>/orderController/queryorderbyid.jhtml",
                data:{id:id},

            })*/
            window.location.href="<%=request.getContextPath()%>/orderController/queryorderbyid.jhtml?id="+id;
        }
    </script>
</body>
</html>
