...
public class Memberbasic implements Serializable{
    ...
    private String mdatumid;      //关联会员个人资料表


    private String gradename; //会员等级业务字段
    private String datumname; //会员姓名
    private Integer datumgender; //会员性别 1、男2、女
    private String datumbrithday; //会员生日
    private String datumregion; //会员所在地区
    private String datumaddress; //会员详细地址
    ...
    public String getMdatumid() {
        return mdatumid;
    }

    public void setMdatumid(String mdatumid) {
